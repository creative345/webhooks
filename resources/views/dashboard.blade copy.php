...
<style>
    * { margin: 0; padding: 0; box-sizing: border-box; }
    ...
    /* Filter styling */
    #gatewayFilter:hover, #statusFilter:hover, #searchBox:hover { border-color: #111; }
    #gatewayFilter:focus, #statusFilter:focus, #searchBox:focus { border-color: #111; box-shadow: 0 0 0 3px rgba(17, 17, 17, 0.1); }
    ...
    @media (max-width: 900px) {
        ...
        .gateway-tabs-wrapper, .search-group, .status-group {
            min-width: 0;
            max-width: 100%;
            flex: 1 1 100%;
        }
    ...
    .filter-bar, .search-group, .gateway-tabs-wrapper, .status-group, .gateway-tab, .status-select {
        position: relative;
        z-index: 1;
    }
    .status-group, .status-select {
        z-index: 1000;
        position: relative;
    }
</style>
                ...
                <div style="padding: 2rem 2rem 1rem 2rem;">
                    ...
                    <div style="display: flex; align-items: center; gap: 1.5rem; flex-wrap: wrap; margin-bottom: 1.5rem;">
                        <div style="display: flex; align-items: center; gap: 1rem;">
                            <label for="statusFilter" style="font-weight:600; font-size: 1.1rem;"><i class="fa fa-exclamation-circle" style="margin-right: 0.5rem; color: #666;"></i>Status:</label>
                            <select id="statusFilter" style="padding:0.7rem 1.5rem; border-radius:12px; border:2px solid #e5e5e5; font-size:1.05rem; background:#fff; color:#111; font-weight:600; outline:none; cursor:pointer; transition: border-color 0.3s; min-width: 160px;">
                                <option value="">All Status</option>
                                <option value="paid">Paid</option>
                                <option value="pending">Pending</option>
                                <option value="due">Due</option>
